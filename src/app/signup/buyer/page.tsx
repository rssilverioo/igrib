...
import { Mail, Lock, Eye, EyeOff, Sprout, AlertCircle, ShoppingBag } from 'lucide-react';
...
export default function BuyerSignupPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const from = searchParams.get('from') || '/dashboard/buyer';
      router.push(from);
    } catch (err) {
        ...
        <div className="max-w-md w-full">
          ...
          >
            ...
            <p className="mt-2 text-sm text-gray-600">
              Crie sua conta para começar a comprar na plataforma
            </p>
          </motion.div>
